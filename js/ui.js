...
const UI = (() => {
    ...
    container.innerHTML = exercises.map((ex, exIndex) => `
      <div class="exercise-card" data-ex-index="${exIndex}">
        <div class="exercise-card-header">
          <img class="exercise-card-thumb" src="${ex.image || 'images/placeholder.jpg'}" alt="" onerror="this.style.opacity=0">
  ...
  function renderLibraryResults() {
    ...
    container.innerHTML = results.map((ex) => `
      <div class="library-item">
        <img src="${ex.image}" alt="" onerror="this.style.opacity=0">
  ...
  function openExerciseDetail(exIndex) {
    ...
    document.getElementById('ex-detail-img').src = ex.image || '';
