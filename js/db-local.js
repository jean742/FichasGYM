/* ================================================================
   GYM PRO — db-local.js
   Camada de persistência 100% LOCAL baseada em IndexedDB.
   Usada automaticamente quando o Firebase ainda não foi configurado
   (veja js/firebase-config.js), como fallback — o app continua
   funcionando normalmente, só que sem sincronizar entre aparelhos.
